...
namespace Assignment10Ex4
{
    ...
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            {
                Console.WriteLine($"An invalid operation exception has occurred: {ex.Message}");
            }
            catch (Exception ex)
            {
        ...
        private static async Task<Shower> TakeAShowerAsync()
        {
            ...
            //Console.WriteLine("slipping....SLIPPING!!!");
            //throw new InvalidOperationException("Slipped in the shower!");    
        ...
        private static async Task<Drive> DriveToWorkAsync(int time)
        {
            ...
            // throw new Exception("Error occurred while driving to work.");
